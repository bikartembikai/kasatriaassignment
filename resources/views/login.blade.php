...
<body class="bg-gray-50 h-screen w-screen flex items-center justify-center font-sans antialiased">

    <div class="bg-white p-10 rounded-xl shadow-sm border border-gray-100 max-w-sm w-full text-center">
